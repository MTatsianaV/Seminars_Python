...
Вывод:
2.5 10 '''
def ind_farthest_orbit(orbits):    
    new_orbits = [(a,b) for (a,b) in orbits if a!=b]
    space = [(a*b) for (a,b) in new_orbits]
    return new_orbits[space.index(max(space))]
orbits_ = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3)]
print(ind_farthest_orbit(orbits_))